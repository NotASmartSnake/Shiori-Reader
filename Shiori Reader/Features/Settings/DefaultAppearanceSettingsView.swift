    ...
    var body: some View {
        ZStack {
            VStack {
                    ...
                    Section(header: Text("Dictionary Popup"), footer: Text("Choose how the dictionary appears: a sliding card that slides up from the bottom, or a popup that appears as a centered overlay.")) {
                        // Display mode picker
