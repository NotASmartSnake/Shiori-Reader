...
struct LibraryView: View {
    ...
    let booksArray: [Book] = [
        Book(title: "Danmachi", coverImage: "DanmachiCover", readingProgress: 0.1, filePath: "21519.epub"),
        ...
        Book(title: "Hakomari", coverImage: "HakomariCover", readingProgress: 0.6, filePath: ""),
